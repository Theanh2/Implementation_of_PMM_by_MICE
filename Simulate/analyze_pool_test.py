...
def main():
    """Main function to analyze a few test folders"""
    ...
    # Test on just a few folders
    test_folders = [
        "rf__m5_it10_init-sample_vs-random_ntree300_leaf20_depthnone/rep_22",
        "cart__m5_it10_init-sample_vs-random_leaf20_depthnone_alpha0/rep_22",
        "rf__m20_it10_init-sample_vs-random_ntree300_leaf20_depthnone/rep_22"
    ]
    ...
    for test_folder in test_folders:
        ...
        # Analyze this folder
        result = analyze_folder(folder_path, original_data)
        if result:
            all_results[test_folder] = result
    
    # Save summary
    summary_path = os.path.join(base_dir, "test_analysis_summary.json")
    with open(summary_path, 'w') as f:
        json.dump(all_results, f, indent=2, default=str)
    
    print(f"\nTest analysis complete! Summary saved to {summary_path}")

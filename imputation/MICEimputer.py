...
from imputation.zh.validators import check_method, check_n_imputations
from imputation.zh.constants import ImputationMethod, SUPPORTED_METHODS, DEFAULT_METHOD, InitialMethod, SUPPORTED_INITIAL_METHODS, DEFAULT_INITIAL_METHOD
...
class MICEimputer:
    ...
    predictor_matrix : np.ndarray, optional
        ...
        for each target variable. If None, all variables are used as predictors
        for each target.
    ...
    method : Union[str, Dict[str, str]], optional
        ...
        - None: use default method (ImputationMethod.PMM.value) for all columns
        
    Supported methods: ImputationMethod.get_all_methods()
        
    random_state : int, optional
        Random seed for reproducibility
        
    initial : str, default=InitialMethod.SAMPLE.value
        Initial imputation method (InitialMethod.SAMPLE.value or InitialMethod.MEANOBS.value)
        
    method_args : Dict[str, Dict], optional
        Additional arguments to pass to specific imputation methods
    """
    ...
    def __init__(
        ...
        initial: str = InitialMethod.SAMPLE.value,
    ...
    def _get_imputer_func(self, method_name: str) -> Callable:
        ...
        imputer_map = {
            ...
            ImputationMethod.MILES.value: mice_impute_li,
            ImputationMethod.MIDAS.value: mice_impute_midas,
